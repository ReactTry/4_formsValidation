...
const Testform = () => {
  ...
  function validation() {
    ...
    if (fields.skill.length === 0) {
      error.skill = "Select atleast one skill";
      validationStatus = false;
    }
    if (fields.firstname === "") {
      error.firstname = "Name should be entered";
      validationStatus = false;
    }
    if (fields.email === "") {
    ...
    if (fields.country === "") {
      error.country = "Couuntry Not selected";
      validationStatus = false;
    }

    if (fields.dob === "") {
      error.dob = "Dob should entered";
      validationStatus = false;
    }
